...
{  
 ...
 {  
  if ((!(currentweapon player in ["launch_I_Titan_short_F","launch_O_Titan_short_F","launch_B_Titan_short_F","launch_Titan_short_F","launch_Titan_F","launch_O_Titan_F","launch_I_Titan_F","launch_B_Titan_F"])||(cameraView != "GUNNER")) && (player == vehicle player)) then 
  { 
